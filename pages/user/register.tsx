...
import {Address, User} from "../../lib/models/User";
            ...
            <section className={"flex items-center justify-center h-full"}>
                <form onSubmit={onSubmit} className={"flex flex-col space-y-4 p-4 items-center"}>
                    <div className={"flex flex-row items-center"}>
                        ...
                        <div>
                            <div className="text-zinc-600 text-sm font-medium leading-normal">{t('country')}</div>
                            <input
                                className="w-80 h-11 px-3.5 py-2.5 rounded-md border border-gray-200 justify-start items-center gap-2 inline-flex"
                                name={"country"} type={"text"}/>
                            <div className="text-zinc-600 text-sm font-medium leading-normal">{t('state')}</div>
                            <input
                                className="w-80 h-11 px-3.5 py-2.5 rounded-md border border-gray-200 justify-start items-center gap-2 inline-flex"
                                name={"state"} type={"text"}/>
                            <div className="text-zinc-600 text-sm font-medium leading-normal">{t('city')}</div>
                            <input
                                className="w-80 h-11 px-3.5 py-2.5 rounded-md border border-gray-200 justify-start items-center gap-2 inline-flex"
                                name={"city"} type={"text"}/>
                            <div className="text-zinc-600 text-sm font-medium leading-normal">{t('complement')}</div>
                            <input
                                className="w-80 h-11 px-3.5 py-2.5 rounded-md border border-gray-200 justify-start items-center gap-2 inline-flex"
                                name={"complement"} type={"text"}/>
                            <div className="text-zinc-600 text-sm font-medium leading-normal">{t('street')}</div>
                            <input
                                className="w-80 h-11 px-3.5 py-2.5 rounded-md border border-gray-200 justify-start items-center gap-2 inline-flex"
                                name={"street"} type={"text"}/>
                            <div className="text-zinc-600 text-sm font-medium leading-normal">{t('district')}</div>
                            <input
                                className="w-80 h-11 px-3.5 py-2.5 rounded-md border border-gray-200 justify-start items-center gap-2 inline-flex"
